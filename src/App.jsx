        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-black/30 backdrop-blur-xl">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
              <p className="text-sm font-semibold text-zinc-200">3D Scene (Spline)</p>
          ...
          <div className="mt-4 flex items-center gap-2 text-xs text-zinc-500">
            ...
            Tip: si se ve pesado en tu laptop, reemplázalo por una imagen o baja la calidad del scene.
          </div>
        </div>
      </div>
    </section>
  ...
  const items = [
    {
      ...
      role: "Cliente",
      avatar: "public/JUAN.jpg", // pon en /public
...
function Contact() {
  ...
  const mailto = useMemo(() => {
    const to = "bryan@example.com"; // cambia
    const subject = encodeURIComponent(form.subject || "Contacto desde el portafolio");
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-black/30 p-7 backdrop-blur-xl">
            <div className="flex items-center gap-4">
              <img
                src="public/BRYAN.png" // pon tu foto en /public
                alt="Bryan"
          ...
          >
            ...
            <button
              type="submit"
              className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-2xl px-5 py-3 text-sm font-semibold text-black transition hover:scale-[1.01]"
